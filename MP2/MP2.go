...
//type block struct {
//	id intgossip transaction rcv not enough length
//	pre_hash string
//	self_hash string
//	solution string
...
//func messageRcv(conn *net.TCPConn) {
//	buff := make([]byte, 256)
//	for {
//		j, err := conn.Read(buff)
//		checkError(err)
//		recevied_lines := strings.Split(string(buff[0:j]), "\n")
//		fmt.Println(recevied_lines)
//	}
//}
...
//func commit(filename string, context []string){
...
func main() {
	...
	// 10.192.186.30
	// 10.182.188.148
	var intro_serv_ip = "10.182.188.148:4444"
