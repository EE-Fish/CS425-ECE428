...
class Node:
    def __init__(self, host, name, port,n,heartbeat_port,interval):
        ...
        # self.connection = ["sp19-cs425-g57-01.cs.illinois.edu":1, "sp19-cs425-g57-02.cs.illinois.edu":2, 
        #                    "sp19-cs425-g57-03.cs.illinois.edu":3, "sp19-cs425-g57-04.cs.illinois.edu":4,
        #                    "sp19-cs425-g57-05.cs.illinois.edu":5, "sp19-cs425-g57-06.cs.illinois.edu":6,
        #                    "sp19-cs425-g57-07.cs.illinois.edu":7, "sp19-cs425-g57-08.cs.illinois.edu":8,
        #                    "sp19-cs425-g57-09.cs.illinois.edu":9, "sp19-cs425-g57-010.cs.illinois.edu":10,]
        self.stamp = [0] * 10
...
#-------------------------Reliable Multicast-------------------------------  
    ...
    #     s4.bind((self.host, self.reliable_port))
    #     s4.listen(10)
    #     while True:
    #         conn, addr = s4.accept()
    #         # print 'Connected by ', addr
